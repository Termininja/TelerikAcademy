    ...
    public class AllTasks
    {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        PrintButton(" to try again or ", "Esc");
                        PrintButton(" to go to Main Menu . . .", null);
      ...
      Task 3: Create a hierarchy  Dog, Frog, Cat, Kitten, Tomcat  and define useful constructors
              ...
              animals and calculate the average age of each kind of animal using a static method.
                         ");
            Console.ResetColor();
            PrintButton("   Please, select a task number from ", "1");
            PrintButton(" to ", "3");
            PrintButton(" or press ", "Esc");
            PrintButton(" to exit... ", null);
        }

        private static void PrintButton(string text, string key)
        {
        ...
        private static void InOut(string text)
        {
