...
{
    // Checks for collision between some objects
            ...
            foreach (var movingObject in movingObjects)
            {
                ...
                if (verticalIndex != -1)
                {
                    ...
                    staticObjects[verticalIndex].RespondToCollision(
                        new CollisionData(new MatrixCoords(movingObject.Speed.Row, 0), movingObject.GetCollisionGroupString()));
                }
                ...
                if (horizontalIndex != -1)
                {
                    ...
                    staticObjects[horizontalIndex].RespondToCollision(
                        new CollisionData(new MatrixCoords(0, movingObject.Speed.Col), movingObject.GetCollisionGroupString()));
                }
