...
class PrimeNumbers
{
    static void Main()
    {
        ...
        while (true)
        {
            ...
            {
                Console.ResetColor();
                ulong number = ulong.Parse(str);                            // use type 'ulong' to cover the range from 0 to 18,45E+18
                ...
                for (ulong n = 2; n <= number; n++)                         // start checking whether the 'number' is prime
                {
                    bool isPrime = true;
                    for (ulong k = 2; k < n; k++)
                    {
                    ...
                    if (isPrime)                                            // counter for prime numbers
                    {
                        Console.CursorTop = 5;
            ...
            {
                if (str == "end") break;                                    // to exit you have to write "end"
