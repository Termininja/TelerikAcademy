var Animal;
(function (Animal) {
    function CreateAnimal(type, sort, name, kind, position, age, weight) {
        var animal;
        ...
        console.info('A new ' + ((kind) ? sort + ' ' : '') + 'animal ' + animal.constructor.name + ' (type: ' + type + ', name: ' + name + ') was created.');
