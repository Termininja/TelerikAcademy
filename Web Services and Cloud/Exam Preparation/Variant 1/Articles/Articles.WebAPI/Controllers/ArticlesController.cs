namespace Articles.WebAPI.Controllers
{
    ...
    public class ArticlesController : BaseApiController
    {
        ...
        //GET (public): api/articles?page=0
        [HttpGet]
        ...
        //GET: api/articles?category=[categoryName]&page=0
        [HttpGet]
        public IHttpActionResult Get(string category, int page)
        {
            var articles = GetAllSortedByDate().Where(a => category != null ? a.Category == category : true).Skip(page * defaultPageSize).Take(defaultPageSize);
        ...
        {
            return this.data.Articles.All().OrderByDescending(a => a.DateCreated).Select(ArticleDataModel.FromArticle);
        }
        #endregion
    }
}
